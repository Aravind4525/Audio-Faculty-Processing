...
def process_audio_file(input_type, input_source):
    ...
    if input_type == "google_drive":
        ...
        local_audio_file_path = "audio_file3.mp3"
...
def process_audio(course_id, input_type="google_drive", input_source=None, server_type="dev"):
    ...
    if not input_source:
        if input_type == "google_drive":
            ...
            input_source = "1Ll9yM0YPFTl1UZsUHZEsPCl7S0PIroyC"  # Default Google Drive ID
        else:
...
if __name__ == '__main__':
    ...
    # result = process_audio(input_type="google_drive", input_source="1Ll9yM0YPFTl1UZsUHZEsPCl7S0PIroyC", course_id=212)
    # print(result)
